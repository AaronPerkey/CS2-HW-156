...
public class InvoiceReport {
	...
	public static void outputSummary(List<Invoice> invoice, List<Store> stores,
		...
		// Writing the store summary report
				...
				for (int i = 0; i < stores.size(); i++) {
					...
					int sales = stores.get(i).getInvoice().size();
					totalSales += sales;
	...
	public static void main(String[] args) {
		List<Invoice> invoices = DataConverter.parseDataFileInvoice("data/Invoices.csv");
		List<Store> stores = DataConverter.parseDataFileStore("data/Stores.csv");
